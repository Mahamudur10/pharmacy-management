...
import { 
  ...
  DollarSign, Package, CheckCircle, Calendar, Clock,
  Star, Heart, TrendingUp, Award, Truck, Shield
} from "lucide-react";
...
export default function ShopPage() {
  ...
  // NaN সুরক্ষা সহ total calculation
  const calculateTotal = () => {
    const total = cart.reduce((sum, i) => sum + (i.total || 0), 0);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap justify-between items-center gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Shop Medicines</h1>
            <p className="text-sm text-gray-500 mt-0.5">Browse and purchase medicines</p>
          </div>
        </div>
        {cart.length > 0 && (
          <button
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-emerald-600">{stats.cartItems}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-emerald-600">{formatTK(stats.cartTotal)}</p>
            </div>
            <div className="bg-emerald-100 p-2 rounded-lg">
          ...
          <div className="max-h-[500px] overflow-y-auto divide-y divide-gray-100">
            {filteredMeds.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-sm text-gray-400 mt-1">Try different search term</p>
              </div>
            ) : (
              filteredMeds.map((m) => (
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-2 mt-1">
                        <span className="text-xs text-gray-500 bg-gray-100 px-2 py-0.5 rounded-full">{m.category || "N/A"}</span>
            ...
            <>
              ...
              <div className="p-4 border-t border-gray-100 bg-gray-50">
                <div className="space-y-2">
                  ...
                  <button
                    onClick={checkout}
                    className="w-full bg-gradient-to-r from-emerald-500 to-teal-500 text-white py-3 rounded-xl hover:from-emerald-600 hover:to-teal-600 transition font-semibold shadow-sm mt-3"
                  >
                    Checkout
                  </button>
                </div>
          ...
          <div className="bg-white rounded-2xl max-w-md w-full max-h-[85vh] overflow-y-auto shadow-xl">
            ...
            <div className="p-5">
              ...
              <div className="border-t border-gray-100 pt-3">
                <div className="flex justify-between text-lg font-bold">
                  <span>Total:</span>
                  <span className="text-emerald-600">{formatTK(invoice.total)}</span>
                </div>
              </div>
            </div>
